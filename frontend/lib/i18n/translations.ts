...
export const translations = {
  en: {
    ...
    chat_send_listing: 'Send apartment',
    chat_send_listing_label: 'Apartment',
    ...
    chat_sending_listing: 'Sending apartment...',
    chat_image_sent: 'Image',
    chat_voice_sent: 'Voice message',
    chat_listing_sent: 'Apartment',
    chat_pick_listing_title: 'Send an Apartment',
    chat_pick_listing_sub: 'Choose a listing to share in this chat.',
    chat_pick_listing_empty: 'No listings available.',
    chat_pick_listing_search: 'Search listings...',
    chat_pick_listing_loading: 'Loading listings...',
    chat_send: 'Send',
    chat_listing_view: 'View Apartment',
    chat_listing_price: '{currency}{price}',
    chat_listing_house: 'House Type: {type}',
    chat_listing_location: 'Location: {location}',
    chat_voice_error: 'Voice recording is not supported in this browser.',
    chat_listing_picker: 'Apartments',
  ...
  tr: {
    ...
    chat_send_listing: 'Daire gönder',
    chat_send_listing_label: 'Daire',
    ...
    chat_sending_listing: 'Daire gönderiliyor...',
    chat_image_sent: 'Resim',
    chat_voice_sent: 'Sesli mesaj',
    chat_listing_sent: 'Daire',
    chat_pick_listing_title: 'Daire Gönder',
    chat_pick_listing_sub: 'Bu sohbette paylaşmak için bir ilan seçin.',
    chat_pick_listing_empty: 'Kullanılabilir ilan yok.',
    chat_pick_listing_search: 'İlanlarda ara...',
    chat_pick_listing_loading: 'İlanlar yükleniyor...',
    chat_send: 'Gönder',
    chat_listing_view: 'Daireyi Görüntüle',
    chat_listing_price: '{currency}{price}',
    chat_listing_house: 'Ev Tipi: {type}',
    chat_listing_location: 'Konum: {location}',
    chat_voice_error: 'Ses kaydı bu tarayıcıda desteklenmiyor.',
    chat_listing_picker: 'Daireler',
